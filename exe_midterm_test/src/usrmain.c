...
#define	SOUND_SENSOR_PORT	2	//피치센서 포트 번호

/* 센서 값 */
#define SOUND_MIN_VALUE		150	//피치센서 경계 값

/* 모터 속도 */
#define MAX_SPEED	700	//최대 모터 스피드
#define DEFAULT_SPEED	250	//기본 모터 스피드 500
