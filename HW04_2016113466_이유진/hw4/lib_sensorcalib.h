...
#define COLOR_RED			0	// light sensor red
#define COLOR_YELLOW		1	// light sensor yellow
#define COLOR_BLUE			2 	// light sensor blue
#define COLOR_GREEN		3	// light sensor green
...
static int color_value[MAX_COLOR_LEVEL] = {0, 0, 0, 0};
